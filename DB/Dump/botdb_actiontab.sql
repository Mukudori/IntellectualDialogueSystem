...
INSERT INTO `actiontab` VALUES (1,'Вопрос-Ответ','Обыный ответ на вопрос',0),(2,'Обращение к БД','Обращение к сторонней базе данных для получения информации',0),(3,'Приветствие','Реакция на приветствие клиента',0),(4,'Запрос системного времени','Сообщение типа \"дата время\"',1),(5,'Тестовое действие','Действие для отладки',1),(6,'Проверочное действие','',1),(7,'Активировать режим ИИ','',1),(8,'Вывод информации о клиенте','',1),(9,'Запрос расписания на сегодня','',1),(10,'Запрос номера недели','Считает какая по счету сейчас неделя. Первая неделя это 1 февраля',1),(12,'Запрос расписания на текущую неделю','',1),(13,'Расписание на следующую неделю','',1),(14,'Запрос последних 3х новостей','Запрос последних 3х новостей из файла webData.wd',1),(15,'Проверка свободной аудитории сейчас','',1),(16,'Проверка свободной аудитории (день, пара)','',1);
